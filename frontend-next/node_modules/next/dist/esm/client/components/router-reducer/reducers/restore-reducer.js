...
import { FreshnessPolicy, resetNavigationLockToPending, spawnDynamicRequests, startPPRNavigation } from '../ppr-navigations';
...
export function restoreReducer(state, action) {
    ...
    const task = startPPRNavigation(now, currentUrl, state.renderedSearch, state.cache, state.tree, restoreSeed.routeTree, restoreSeed.metadataVaryPath, FreshnessPolicy.HistoryTraversal, null, null, restoreSeed.dynamicStaleAt, false, accumulation, // A history-traversal restore is bound to the shared map.
